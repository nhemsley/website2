<script>
  ...
  export let skills = [
    ...
    { name: 'JavaScript', category: 'Frontend', proficiency: 9, projects: 25 },
    { name: 'TypeScript', category: 'Frontend', proficiency: 8, projects: 15 },
    ...
    { name: 'PostgreSQL', category: 'Database', proficiency: 8, projects: 15 },
  ...
  function createChart() {
    ...
    simulation = d3
      ...
      .force(
        'collide',
        d3.forceCollide((d) => d.radius + 2).strength(0.8)
      )
  ...
  // Re-create chart when filtered skills change
